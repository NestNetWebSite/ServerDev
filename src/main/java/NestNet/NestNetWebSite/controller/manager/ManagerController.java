...
public class ManagerController {
    ...
    회원가입 미승인
     */
    @PostMapping("/manager/reject-signup")
    @Operation(summary = "회원가입 요청 단건 거절", description = "하나의 회원가입 요청을 거절한다. 회원가입 요청을 찾을 수 없을 시 500 에러를 반환한다.")
    public ApiResult<?> rejectSignUpMember(@Valid @RequestBody MemberSignUpManagementRequest dto){

        return managerService.rejectSignUp(dto);
    }
    ...
    회원 탈퇴
     */
    @DeleteMapping("/manager/member-withdraw")
