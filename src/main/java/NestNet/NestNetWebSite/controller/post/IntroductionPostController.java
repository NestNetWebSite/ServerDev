...
public class IntroductionPostController {
    ...
    @Operation(summary = "자기 소개 게시물 단건 조회", description = "자기 소개 게시물 목록을 조회한다.")
    public ApiResult<?> showPostList(@PathVariable("post_id") Long postId, @AuthenticationPrincipal UserDetails userDetails){
